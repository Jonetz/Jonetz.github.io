...
$P(\mid X-\mu \mid > \epsilon) \leq \frac{Var(X)} {\epsilon^2} = \frac{\sigma^2}{n \cdot \epsilon^2} \approx 0 $ with $n \rightarrow \infty$ 
...
$H=\mid \mid X \mid \mid_2 = \sqrt{\Sigma_{i=0}^n X_i^2}$
...
$q(x_t \mid x_0) = N(\sqrt{\alpha_t}x_0, (1-\alpha_t) I)$ with $\alpha$ as the temperature parameter.
