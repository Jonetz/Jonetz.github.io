...
excerpt: "Artificial Intelligence for non Techies III" 
...
independence is a method often used to simplify the problem. Considering the norm, a new stochastic variable $X' = \sqrt(X_1^2+X_2^3 + ... + X_n^2)$ for which $||X||_2 = X'$.
Now we can determine the expected value of $X$:

$E(||X||_2^2) = \Sigma_{i=0}^n E(X_i^2) = n\sigma ^2 $
...
Then, the expected value of $||X||$ can be used in this equation:

$ \frac{||X||_2^2}{n} = \frac{1}{n}\Sigma_{i=0}^n X_i^2 \approx \sigma^2\ \ $

In high dimensions, this results in a concentration of the norm around $\sqrt{n}$:

$ ||X||_2 \approx \sqrt{n} \sigma \ \ $ for large $n$
...
<div style="text-align:center">
    <a>
        <img src="images\No-Tech-Articles\var_norm_concentration.jpg" alt="Simulation of the Code" style="width:70%;height:70%"> 
    </a>
</div>
...
$||X-Y||_2 = \sqrt{((X_1^2 + ... + X_n^2) - (Y_1^2 + ... + Y_n^2))}$
...
Applied to the norm $||X-Y||$, this means that this distance is highly likely to be
...
<div style="text-align:center">
    <a>
        <img src="images\No-Tech-Articles\var_dist_concentration.jpg" alt="Simulation of the Code" style="width:70%;height:70%"> 
    </a>
</div>
...
$H = ||X||_2 = \sqrt{\Sigma_{i=0}^n X_i^2}$
...
**Derivation**
The use of normally distributed features leads to a chi-square distributed multidimensional variable $||X||^2$. The expected value of this norm is very reliably $\sqrt{n}$, as already demonstrated in Section 2.1. This follows from the norm concentration of vectors with independent features.

The distance between the two points—i.e., the hypotenuse of the triangle—can be squared as $E(||X-Y||^2)$ using the normal distribution of the individual variables $X$ and $Y$. Since $X$ and $Y$ consist of components with variance $1$ and expected value $0$, inserting the result from section 2.2 (distance concentration) yields a value of $2n$. This means that we have a high probability of a distance of 2d for the hypotenuse and a distance of d for the legs. According to Pythagoras' theorem, this always corresponds to an almost right angle.
...
<div style="text-align:center">
    <a>
        <img src="images\No-Tech-Articles\var_angle_concentration.jpg" alt="Simulation of the Code" style="width:70%;height:70%"> 
    </a>
</div>
...
<div style="text-align:center">
    <a>
        <img src="images\No-Tech-Articles\vol_circles.jpg" alt="Volumes of balls with different dimensions, retrieved from Wikipedia." style="width:70%;height:70%"> 
    </a>
</div>
